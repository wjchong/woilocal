...
<head>
    ...
    <link href="<?=base_url();?>assets/css/escort.css" rel="stylesheet">
    <link href="<?=base_url();?>assets/css/blog.css" rel="stylesheet">
    <link href="<?=base_url();?>assets/css/adminbanner.css" rel="stylesheet">
        ...
        <div class="header">
            <div class="nav-header">
                <div class="brand-logo">
                    <a href="index.html">
                        <b><img src="<?=base_url();?>assets/images/logo.png" alt=""> </b>
                            ...
                            <div class="drop-down animated bounceInDown">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <img class="pull-left m-r-10 avatar-img" src="<?=base_url();?>assets/images/avatar/1.jpg" alt="">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="pull-left m-r-10 avatar-img" src="<?=base_url();?>assets/images/avatar/2.jpg" alt="">
                                                <div class="notification-content"><small class="notification-timestamp pull-right">02:34 PM</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="pull-left m-r-10 avatar-img" src="<?=base_url();?>assets/images/avatar/3.jpg" alt="">
                                                <div class="notification-content"><small class="notification-timestamp pull-right">02:34 PM</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="pull-left m-r-10 avatar-img" src="<?=base_url();?>assets/images/avatar/4.jpg" alt="">
                                                <div class="notification-content"><small class="notification-timestamp pull-right">02:34 PM</small>
                            ...
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="/Auth/logout"><i class="icon-power"></i> <span>Logout</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
