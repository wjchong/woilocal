...
if(isset($_POST['filter'])){
    ...
    //$merchant_sql = mysqli_query($conn, "SELECT * FROM users WHERE user_roles='2' AND mobile_number LIKE '%".$telephone."%' AND referral_id LIKE '%".$referral."%'");
    ...
    //$merchant_sql = mysqli_query($conn, "SELECT * FROM users WHERE user_roles='2'");
