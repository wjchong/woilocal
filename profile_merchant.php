...
if(isset($_POST['submit']))
{
    ...
    $process_password_need=$_POST['process_password_need'];
	...
	$stock_inventory = addslashes(isset($_POST['stock_inventory']) ? $_POST['stock_inventory'] : '');
	$cash_system = addslashes(isset($_POST['cash_system']) ? $_POST['cash_system'] : '');
	...
	if($process_password_need =="on") $process_password_need = '1';
	else $process_password_need = "0";
...
else
{
	...
	$process_password_need = $bank_data['process_password_need'];
							...
							<form method="post" enctype="multipart/form-data" id="profile_account">
								<div class="panel price panel-red">
									...
									<div class="form-group">
										...
										<label>Location Range<br></label>
										<input type="Number" name="location_range" maxlength='3'  class="form-control" value="<?php if(isset($location_range)){ echo $location_range; }?>">
									</div> 
									<div class="form-group">  
									...
									<div class="form-group">
										<label>Cash System</label><br>
										<input class="cash_system" type="checkbox" name="cash_system" <?php if($cash_system) echo "checked='checked'";?> > Cash System<br>
										
									</div>   
									<div class="form-group">
										<label>Stock Inventory</label><br>
										<input class="stock_inventory" type="checkbox" name="stock_inventory" <?php if($stock_inventory) echo "checked='checked'";?> > Stock Inventory<br>
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
                                        <label>Pos Type Layout</label>
                                        <select class='menu_type' name="pos_type" style="">
                                            <option <?php if($pos_type == '1') echo 'selected'; ?> value="1">Normal Layout</option>
                                            <option <?php if($pos_type == '2') echo 'selected'; ?> value="2">SubCategory Layout</option>
                                        </select>
                                    </div>   
                                   <div class="form-group">
...
<script>
function fetchdata(){
var phone = '<?php echo $bank_data['mobile_number']; ?>';  
var message = 'Koofamilies alert ! Your order has exceeded timeframe, please investigate. Kitchen Jam? If Internet problem, please contact 012-3115670 for assistance';
 $.ajax({
  url: 'send_sms.php',
  type: 'post',
...
var counter = <?php if(isset($pending_time)){ echo $pending_time; }else{echo '15';}?>*60;
